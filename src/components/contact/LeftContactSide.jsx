...
const LeftContactSide = () => {
  return (
    <div className=" xmd:w-[30%] w-full flex flex-col gap-6 ">
      {ContactData?.map((item, index) => (
        <div
          key={index}
          className=" lg:py-7 py-5 lg:px-6 px-4  flex items-center gap-4 bg-[#E6EEEE] duration-300 group hover:bg-secondaryColor rounded-[16px]"
        >
