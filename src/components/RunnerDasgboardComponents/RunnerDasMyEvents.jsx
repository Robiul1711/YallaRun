...
const RunnerDasMyEvents = () => {
  ...
  const categories = ['Upcoming', 'Complete',];
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-4 xl:p-6">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className=" text-2xl sm:text-3xl font-bold text-gray-900 mb-2">My Events</h1>
          <p className="text-gray-600">Track the events you’ve joined and stay updated on your upcoming runs.</p>
        </div>
...
export default RunnerDasMyEvents;
