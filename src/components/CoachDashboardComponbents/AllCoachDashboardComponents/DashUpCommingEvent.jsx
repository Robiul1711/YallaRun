      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm">
            Your scheduled event participation
          </p>
        </div>
        ...
        {articles.map((article) => (
          ...
          >
            ...
            <div className="flex-shrink-0">
              <span
                className={`px-3 py-1 rounded-full text-white text-sm font-medium ${article.statusColor}`}
              >
                {article.status}
              </span>
            </div>
...
export default DashUpCommingEvent;
